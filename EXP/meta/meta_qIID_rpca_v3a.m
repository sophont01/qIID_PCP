...
%% RGB + Sharp + Smooth
[A,E] = func_qIID_rpca_v3a(I,shI,sI,1.0);
...
imshow([I ia11 ie11; shI ia12 ie12; sI ia13 ie13])
...
imwrite(ia11,'rgb_sharp_smooth_A.png');
system('python /home/saurabh/WORK/CODES/qIID/qIID_PCP/evaluate/whdr.py --linear rgb_sharp_smooth_A.png /media/saurabh/String/WORK/DATASETS/iiw-dataset/data/21571.json')