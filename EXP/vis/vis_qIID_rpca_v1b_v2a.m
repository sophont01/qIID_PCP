%% Color shift in E component using LAB space and weighed according to E intensity values
...
switch idx
    ...
    case 2
        recon = w1e.*rE{1} + w2e.*rE{2} + w2a.*A{2};
    case 3
        recon = w1e.*rE{1} + w2e.*rE{2} + w3e.*rE{3} + w3a.*A{3};
    case 4
        recon = w1e.*rE{1} + w2e.*rE{2} + w3e.*rE{3} + w4e.*rE{4} + w4a.*A{4};
    case 5
        recon = w1e.*rE{1} + w2e.*rE{2} + w3e.*rE{3} + w4e.*rE{4} + w5e.*rE{5} + w5a.*A{5};
    otherwise
...
function[recon] = modifyComponents(A,E,rE,idx)
...
switch idx
    ...
    case 2
        recon = A{2}+rE{1}+rE{2};
    case 3
        recon = A{3}+rE{1}+rE{2}+rE{3};
    case 4
        recon = A{4}+rE{1}+rE{2}+rE{3}+rE{4};
    case 5
        recon = A{5}+rE{1}+rE{2}+rE{3}+rE{4}+rE{5};
    otherwise
        recon = A{5}+E{1}+E{2}+E{3}+E{4}+E{5};
end
