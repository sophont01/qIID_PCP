%% run v1b on all RevisitingIID shading images on HDR testset
...
addpath(genpath('./EXP'))
Rpath = './RESULTS/';
Dpath = '/media/saurabh/Rythym/WORK/RESULTS/revisitingIID/HDR/testset/';
...
for d=44:numel(D) 
    ...
    Ipath = fullfile(Dpath, [Inum '-S.png']);
