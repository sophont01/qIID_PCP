function varargout = gui2_vis5b_meta5_qIID_rpca_v1b(varargin)
% GUI2_VIS5B_META5_QIID_RPCA_V1B MATLAB code for gui2_vis5b_meta5_qIID_rpca_v1b.fig
%      GUI2_VIS5B_META5_QIID_RPCA_V1B, by itself, creates a new GUI2_VIS5B_META5_QIID_RPCA_V1B or raises the existing
%      singleton*.
%
%      H = GUI2_VIS5B_META5_QIID_RPCA_V1B returns the handle to a new GUI2_VIS5B_META5_QIID_RPCA_V1B or the handle to
%      the existing singleton*.
%
%      GUI2_VIS5B_META5_QIID_RPCA_V1B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI2_VIS5B_META5_QIID_RPCA_V1B.M with the given input arguments.
%
%      GUI2_VIS5B_META5_QIID_RPCA_V1B('Property','Value',...) creates a new GUI2_VIS5B_META5_QIID_RPCA_V1B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui2_vis5b_meta5_qIID_rpca_v1b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui2_vis5b_meta5_qIID_rpca_v1b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui2_vis5b_meta5_qIID_rpca_v1b

% Last Modified by GUIDE v2.5 04-Oct-2019 19:18:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui2_vis5b_meta5_qIID_rpca_v1b_OpeningFcn, ...
                   'gui_OutputFcn',  @gui2_vis5b_meta5_qIID_rpca_v1b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui2_vis5b_meta5_qIID_rpca_v1b is made visible.
function gui2_vis5b_meta5_qIID_rpca_v1b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui2_vis5b_meta5_qIID_rpca_v1b (see VARARGIN)

% Choose default command line output for gui2_vis5b_meta5_qIID_rpca_v1b
...
% UIWAIT makes gui2_vis5b_meta5_qIID_rpca_v1b wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui2_vis5b_meta5_qIID_rpca_v1b_OutputFcn(hObject, eventdata, handles) 
